...
class EncodeVideoReel implements ShouldQueue
{
  ...
  public function handle()
  {
    ...
    try {
      ...
      $this->handleFailedJob($reel, $videoPathDiskMp4, $videoPoster);
  ...
  public function handleFailedJob($reel, $videoPathDisk, $videoPoster = null)
  {
    ...
    // Delete file
    $this->deleteFile($temp . $videoPathDisk);

    // Delete file temp
    $this->deleteFile($temp . $media->name);

    if ($videoPoster) {
      $this->deleteFile($temp . $videoPoster);
    }
   ...
   */
  public function failed($reel, $videoPathDisk, $videoPoster): void
  {
    self::handleFailedJob($reel, $videoPathDisk, $videoPoster);
  }
