          ...
          <div class="bg-white rounded-lg shadow-sm p-5">
            ...
            @php
              switch (auth()->user()->pm_type) {
                case 'amex':
                  $paymentDefault = '<img src="'.asset('/imgpayments/brands/amex.svg').'"> •••• •••• •••• '.auth()->user()->pm_last_four;
                  break;

                case 'diners':
                $paymentDefault = '<img src="'.asset('/imgpayments/brands/diners.svg').'"> •••• •••• •••• '.auth()->user()->pm_last_four;
                break;

                case 'discover':
                $paymentDefault = '<img src="'.asset('/imgpayments/brands/discover.svg').'"> •••• •••• •••• '.auth()->user()->pm_last_four;
                break;

                case 'jcb':
                $paymentDefault = '<img src="'.asset('/imgpayments/brands/jcb.svg').'"> •••• •••• •••• '.auth()->user()->pm_last_four;
                break;

                case 'mastercard':
                $paymentDefault = '<img src="'.asset('/imgpayments/brands/mastercard.svg').'"> •••• •••• •••• '.auth()->user()->pm_last_four;
                break;

                case 'unionpay':
                $paymentDefault = '<img src="'.asset('/imgpayments/brands/unionpay.svg').'"> •••• •••• •••• '.auth()->user()->pm_last_four;
                break;

                case 'visa':
                $paymentDefault = '<img src="'.asset('/imgpayments/brands/visa.svg').'"> •••• •••• •••• '.auth()->user()->pm_last_four;
                break;
