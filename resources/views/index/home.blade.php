  ...
  <div class="section py-5 py-large">
    <div class="container">
        <div class="btn-block text-center mb-5">
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="text-center">
                <img style="width:640px!important" src="{{url('public/img', $settings->img_1)}}" class="img-center img-fluid" width="120">
          ...
          <div class="col-lg-4">
            <div class="text-center">
              <img id="center-image" style="width:640px!important" src="{{url('public/img', $settings->img_2)}}" class="img-center img-fluid" width="120">
        ...
        <div class="col-lg-4">
          <div class="text-center">
            <img style="width:640px!important"   src="{{url('public/img', $settings->img_3)}}" class="img-center img-fluid" width="120">
