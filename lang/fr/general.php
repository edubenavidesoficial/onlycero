...
return array(
	...
	*/
	...
	'my_page' => 'Ma page',
	'subtitle_welcome' => 'GlowCherrys est conçu pour aider les créateurs de contenu en ligne. Créez un compte gratuit et commencez à gagner de l’argent dès maintenant.',
	'install_success' => 'Installation terminée avec succès !',

	// Box #2 On Index
	'header_box_2' => 'Commencez à gagner de l’argent maintenant !',
	'desc_box_2' => 'Vos idées et créations méritent d’être récompensées. Avec GlowCherrys, vous avez l’opportunité de transformer votre passion en une véritable source de revenus. Connectez-vous directement avec vos fans et abonnés les plus fidèles, et profitez pleinement des opportunités que nous avons préparées pour vous. Il est temps d’exploiter tout votre talent créatif et de rejoindre notre plateforme dès aujourd’hui !',
	'card_1' => 'Créer un compte gratuit',
	'desc_card_1' => 'Rejoignez la révolution des créateurs sur GlowCherrys. Créez votre compte gratuit pour partager vos œuvres, entrer en contact avec vos abonnés et commencer à gagner de l’argent.',
	'card_2' => 'Créez du contenu de qualité',
	'desc_card_2' => 'Créer un contenu exceptionnel est la clé pour attirer des abonnés. En mettant votre passion dans chaque création et en produisant régulièrement du contenu engageant, vous augmentez votre visibilité et développez votre base de fans. Créez du contenu de qualité et voyez votre prochain rêve se réaliser.',
	'card_3' => 'Développez votre marché',
	'desc_card_3' => 'Vos créations méritent un public plus large. Sur GlowCherrys, nous avons des outils marketing pour étendre votre portée mondiale. Optimisez vos stratégies pour une croissance exponentielle.',

// Box #3 On Index
	'header_box_3' => 'Créez votre profil en quelques minutes',
	'desc_box_3' => 'Créez rapidement et facilement votre profil de créateur avec GlowCherrys. Entrez quelques informations, téléchargez vos créations, et vous êtes prêt à les monétiser. Notre interface intuitive vous guide à chaque étape.',

	'getting_started' => 'Commencer',
	'creators_featured' => 'Créateurs en vedette',
	...
	'title' => 'Titre',
	'optional' => 'Optionnel',
	'username_no_edit' => 'Ne peut pas être modifié',
	...
	'formats_available' => 'Format invalide, seuls JPG, GIF, PNG, MP3, MP4 vidéo ou MOV (QuickTime) sont autorisés.',
	...
	'attach_file_support' => 'Formats supportés :',
	'width_min' => 'La photo doit avoir une largeur supérieure ou égale à :data px', // Ne pas supprimer :data
	'height_min' => 'La photo doit avoir une hauteur supérieure ou égale à :data px', // Ne pas supprimer :data
	'none' => 'Aucun',
	'by' => 'par',
	'like' => 'J’aime',
